...
import {
  ...
  ra,
  rc
} from "./chunk-ZHYUTOBW.js";
import "./chunk-3M6ZHV6D.js";
import "./chunk-GURLHEGR.js";
import {
  i,
  scope
  ...
  var debug = require_debug(), { MAX_LENGTH, MAX_SAFE_INTEGER } = require_constants(), { safeRe: re, safeSrc: src, t } = require_re(), parseOptions = require_parse_options(), { compareIdentifiers } = require_identifiers(), SemVer = class _SemVer {
    ...
    inc(release, identifier, identifierBase) {
      if (release.startsWith("pre")) {
        ...
        if (identifier) {
          let r2 = new RegExp(`^${this.options.loose ? src[t.PRERELEASELOOSE] : src[t.PRERELEASE]}$`), match = `-${identifier}`.match(r2);
...
var require_gt = __commonJS({ "../../node_modules/semver/functions/gt.js"(exports, module2) {
  var compare = require_compare(), gt2 = (a, b, loose) => compare(a, b, loose) > 0;
  module2.exports = gt2;
} });
var require_lt = __commonJS({ "../../node_modules/semver/functions/lt.js"(exports, module2) {
  var compare = require_compare(), lt2 = (a, b, loose) => compare(a, b, loose) < 0;
  module2.exports = lt2;
} });
...
var require_cmp = __commonJS({ "../../node_modules/semver/functions/cmp.js"(exports, module2) {
  var eq = require_eq(), neq = require_neq(), gt2 = require_gt(), gte = require_gte(), lt2 = require_lt(), lte = require_lte(), cmp = (a, op, b, loose) => {
    switch (op) {
      case "===":
...
var require_range = __commonJS({ "../../node_modules/semver/classes/range.js"(exports, module2) {
  var SPACE_CHARACTERS = /\s+/g, Range = class _Range {
    ...
    parseRange(range) {
      ...
      let loose = this.options.loose, hr2 = loose ? re[t.HYPHENRANGELOOSE] : re[t.HYPHENRANGE];
  ...
  var LRU = require_lrucache(), cache = new LRU(), parseOptions = require_parse_options(), Comparator = require_comparator(), debug = require_debug(), SemVer = require_semver(), { safeRe: re, t, comparatorTrimReplace, tildeTrimReplace, caretTrimReplace } = require_re(), { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = require_constants(), isNullSet = (c) => c.value === "<0.0.0-0", isAny = (c) => c.value === "", isSatisfiable = (comparators, options) => {
    ...
    return comp.replace(r2, (_2, M2, m, p, pr) => {
      ...
      let ret;
      return isX(M2) ? ret = "" : isX(m) ? ret = `>=${M2}.0.0 <${+M2 + 1}.0.0-0` : isX(p) ? ret = `>=${M2}.${m}.0 <${M2}.${+m + 1}.0-0` : pr ? (debug("replaceTilde pr", pr), ret = `>=${M2}.${m}.${p}-${pr} <${M2}.${+m + 1}.0-0`) : ret = `>=${M2}.${m}.${p} <${M2}.${+m + 1}.0-0`, debug("tilde return", ret), ret;
    });
    ...
    return comp.replace(r2, (_2, M2, m, p, pr) => {
      ...
      let ret;
      return isX(M2) ? ret = "" : isX(m) ? ret = `>=${M2}.0.0${z} <${+M2 + 1}.0.0-0` : isX(p) ? M2 === "0" ? ret = `>=${M2}.${m}.0${z} <${M2}.${+m + 1}.0-0` : ret = `>=${M2}.${m}.0${z} <${+M2 + 1}.0.0-0` : pr ? (debug("replaceCaret pr", pr), M2 === "0" ? m === "0" ? ret = `>=${M2}.${m}.${p}-${pr} <${M2}.${m}.${+p + 1}-0` : ret = `>=${M2}.${m}.${p}-${pr} <${M2}.${+m + 1}.0-0` : ret = `>=${M2}.${m}.${p}-${pr} <${+M2 + 1}.0.0-0`) : (debug("no pr"), M2 === "0" ? m === "0" ? ret = `>=${M2}.${m}.${p}${z} <${M2}.${m}.${+p + 1}-0` : ret = `>=${M2}.${m}.${p}${z} <${M2}.${+m + 1}.0-0` : ret = `>=${M2}.${m}.${p} <${+M2 + 1}.0.0-0`), debug("caret return", ret), ret;
    });
    ...
    return comp.replace(r2, (ret, gtlt, M2, m, p, pr) => {
      ...
      let xM = isX(M2), xm = xM || isX(m), xp = xm || isX(p), anyX = xp;
      return gtlt === "=" && anyX && (gtlt = ""), pr = options.includePrerelease ? "-0" : "", xM ? gtlt === ">" || gtlt === "<" ? ret = "<0.0.0-0" : ret = "*" : gtlt && anyX ? (xm && (m = 0), p = 0, gtlt === ">" ? (gtlt = ">=", xm ? (M2 = +M2 + 1, m = 0, p = 0) : (m = +m + 1, p = 0)) : gtlt === "<=" && (gtlt = "<", xm ? M2 = +M2 + 1 : m = +m + 1), gtlt === "<" && (pr = "-0"), ret = `${gtlt + M2}.${m}.${p}${pr}`) : xm ? ret = `>=${M2}.0.0${pr} <${+M2 + 1}.0.0-0` : xp && (ret = `>=${M2}.${m}.0${pr} <${M2}.${+m + 1}.0-0`), debug("xRange return", ret), ret;
    });
...
var require_comparator = __commonJS({ "../../node_modules/semver/classes/comparator.js"(exports, module2) {
  var ANY = Symbol("SemVer ANY"), Comparator = class _Comparator {
    ...
    parse(comp) {
      let r2 = this.options.loose ? re[t.COMPARATORLOOSE] : re[t.COMPARATOR], m = comp.match(r2);
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await import("./react-18-3IDAQJLS.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react2.default.createElement(Story, { ...storyContext }) : import_react2.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react2.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react2.default.createElement(Wrapper, null, content) : content;
...
var require_dist = __commonJS({ "../../node_modules/@base2/pretty-print-object/dist/index.js"(exports) {
  var __assign = exports && exports.__assign || function() {
    ...
    for (var r2 = Array(s), k = 0, i2 = 0; i2 < il; i2++) for (var a = arguments[i2], j = 0, jl = a.length; j < jl; j++, k++) r2[k] = a[j];
    return r2;
  };
...
function safeSortObject(value, seen) {
  return value === null || _typeof(value) !== "object" || value instanceof Date || value instanceof RegExp || React__default.isValidElement(value) ? value : (seen.add(value), Array.isArray(value) ? value.map(function(v2) {
...
var dt = Jr((fe, yt) => {
  (function(n, s) {
    ...
    let p = oe2, se = class se2 extends Error {
      constructor(t, o) {
        let i2 = `Unexpected type: '${t.type}'.`;
        o !== void 0 && (i2 += ` Message: ${o}`), super(i2), Object.setPrototypeOf(this, se2.prototype);
      }
    };
    ...
    let z = r((e) => {
      ...
      static create(t) {
        ...
        t = o.text;
        let i2 = this.read(t);
        return t = i2.text, new U2(t, void 0, o.token, i2.token);
      }
      constructor(t, o, i2, l) {
        this.text = "", this.text = t, this.previous = o, this.current = i2, this.next = l;
      }
    ...
    let Ae = class Ae {
      constructor(t, o, i2) {
        this.grammar = t, typeof o == "string" ? this._lexer = xe.create(o) : this._lexer = o, this.baseParser = i2;
      }
      get lexer() {
        return this._lexer;
      }
      ...
      parseInfixIntermediateType(t, o) {
        let i2 = this.tryParslets(t, o);
        for (; i2 !== null; )
          t = i2, i2 = this.tryParslets(t, o);
        return t;
      }
      /**
    ...
    let we = r((e, t, o) => {
      let i2 = e.lexer.current.type, l = e.lexer.next.type;
      return o == null && i2 === "?" && !Ye(l) || o != null && i2 === "?" ? (e.consume("?"), o == null ? {
    ...
    function x(e) {
      let t = r((o, i2, l) => {
        ...
        } else if ("parseInfix" in e && e.precedence > i2 && e.accept(f, d))
    ...
    function Bt({ allowTrailingComma: e }) {
      return x({
        ...
        parseInfix: r((t, o) => {
          ...
          while (t.consume(","));
          if (i2.length > 0 && i2.slice(0, -1).some((l) => l.type === "JsdocTypeVariadic"))
    ...
    let Ct = x({
      ...
      parseInfix: r((e, t) => {
        ...
        let i2 = [];
        do
          i2.push(e.parseType(y.PARAMETER_LIST));
        while (e.consume(","));
        if (!e.consume(">"))
    ...
    function R({ allowedAdditionalTokens: e }) {
      return x({
        ...
        parsePrefix: r((t) => {
          let { type: o, text: i2 } = t.lexer.current;
          return t.consume(o), {
            type: "JsdocTypeName",
            value: i2
          };
    ...
    function te({ pathGrammar: e, allowedTypes: t }) {
      return x({
        ...
        parsePrefix: r((o) => {
          let i2 = o.lexer.current.type;
          if (o.consume(i2), !o.consume(":"))
            return {
              type: "JsdocTypeName",
              value: i2
            };
    ...
    function Se({ allowNamedParameters: e, allowNoReturnType: t, allowWithoutParenthesis: o, allowNewAsFunctionKeyword: i2 }) {
      return x({
        name: "functionParslet",
        accept: r((l, f) => l === "function" || i2 && l === "new" && f === "(", "accept"),
        parsePrefix: r((l) => {
          let f = l.consume("new");
          l.consume("function");
    ...
    let Ge = x({
      ...
      parseInfix: r((e, t) => {
        ...
        if (!e.consume(")")) {
          let i2 = e.parseIntermediateType(y.SYMBOL);
          if (o.element = _t(i2), !e.consume(")"))
          ...
          if (!o.consume("}")) {
            ...
            for (; ; ) {
              ...
              if (d.type === "JsdocTypeNullable" && (h = true, d = d.element), d.type === "JsdocTypeNumber" || d.type === "JsdocTypeName" || d.type === "JsdocTypeStringValue") {
                let E;
                d.type === "JsdocTypeStringValue" && (E = d.meta.quote), i2.elements.push({
            ...
            if (i2.meta.separator = l ?? "comma", !o.consume("}"))
    ...
    function De2({ allowSquaredProperties: e, allowKeyTypes: t, allowReadonly: o, allowOptional: i2 }) {
      return x({
        ...
        parseInfix: r((l, f) => {
          var d;
          let h = false, D = false;
          i2 && f.type === "JsdocTypeNullable" && (h = true, f = f.element), o && f.type === "JsdocTypeReadonlyProperty" && (D = true, f = f.element);
    ...
    function Oe({ allowOptional: e, allowVariadic: t }) {
      return x({
        ...
        parseInfix: r((o, i2) => {
          let l = false, f = false;
          if (e && i2.type === "JsdocTypeNullable" && (l = true, i2 = i2.element), t && i2.type === "JsdocTypeVariadic" && i2.element !== void 0 && (f = true, i2 = i2.element), i2.type !== "JsdocTypeName")
            throw new c(i2);
          o.consume(":");
    ...
    function Gt({ allowQuestionMark: e }) {
      return x({
        ...
        parsePrefix: r((t) => {
          ...
          if (t.consume("]"))
            return o;
          let i2 = t.parseIntermediateType(y.ALL);
          if (i2.type === "JsdocTypeParameterList" ? i2.elements[0].type === "JsdocTypeKeyValue" ? o.elements = i2.elements.map(H) : o.elements = i2.elements.map(J) : i2.type === "JsdocTypeKeyValue" ? o.elements = [H(i2)] : o.elements = [J(i2)], !t.consume("]"))
    ...
    let Xt = x({
      ...
      parsePrefix: r((e) => {
        ...
        if (e.consume(":")) {
          let i2 = e.baseParser;
          i2.acceptLexerState(e), o = {
            type: "JsdocTypeIndexSignature",
            key: t,
            right: i2.parseType(y.INDEX_BRACKETS)
          ...
          i2.acceptLexerState(e), o = {
            ...
            key: t,
            right: i2.parseType(y.ARRAY_BRACKETS)
          }, e.acceptLexerState(i2);
        } else
      ...
      return {
        ...
        JsdocTypeGeneric: r((e, t) => {
          if (e.meta.brackets === "square") {
            let o = e.elements[0], i2 = t(o);
            return o.type === "JsdocTypeUnion" || o.type === "JsdocTypeIntersection" ? `(${i2})[]` : `${i2}[]`;
          } else
    ...
    let pr = {
      ...
      JsdocTypeFunction: r((e, t) => {
        ...
        return o.this !== void 0 && (i2.this = t(o.this)), o.new !== void 0 && (i2.new = t(o.new)), e.returnType !== void 0 && (i2.result = t(e.returnType)), i2;
      }, "JsdocTypeFunction"),
      JsdocTypeGeneric: r((e, t) => ({
      ...
      JsdocTypeObject: r((e, t) => {
        ...
        for (let i2 of e.elements)
          i2.type !== "JsdocTypeObjectField" && i2.type !== "JsdocTypeJsdocObjectField" ? o.fields.push({
            type: "FieldType",
            key: t(i2),
            value: void 0
          }) : o.fields.push(t(i2));
      ...
      JsdocTypeNamePath: r((e, t) => {
        let o = t(e.left), i2;
        e.right.type === "JsdocTypeSpecialNamePath" ? i2 = t(e.right).name : i2 = j(e.right.value, e.right.meta.quote);
        let l = e.pathType === "inner" ? "~" : e.pathType === "instance" ? "#" : ".";
        return F(`${o.name}${l}${i2}`);
      }, "JsdocTypeNamePath"),
      JsdocTypeSymbol: r((e) => {
        let t = "", o = e.element, i2 = false;
        return (o == null ? void 0 : o.type) === "JsdocTypeVariadic" && (o.meta.position === "prefix" ? t = "..." : i2 = true, o = o.element), (o == null ? void 0 : o.type) === "JsdocTypeName" ? t += o.value : (o == null ? void 0 : o.type) === "JsdocTypeNumber" && (t += o.value.toString()), i2 && (t += "..."), F(`${e.value}(${t})`);
      }, "JsdocTypeSymbol"),
    ...
    let ur = {
      ...
      JsdocTypeFunction: r((e, t) => {
        ...
        return o.this !== void 0 ? i2.this = t(o.this) : e.arrow || (i2.this = null), o.new !== void 0 && (i2.new = t(o.new)), e.returnType !== void 0 && (i2.returns = t(e.returnType)), i2;
      }, "JsdocTypeFunction"),
      JsdocTypeGeneric: r((e, t) => {
        let o = {
          type: "GENERIC",
      ...
      JsdocTypeObject: r((e, t) => {
        let o = [];
        for (let i2 of e.elements)
          (i2.type === "JsdocTypeObjectField" || i2.type === "JsdocTypeJsdocObjectField") && o.push(t(i2));
        return {
          type: "RECORD",
          entries: o
        };
      ...
      JsdocTypeNamePath: r((e, t) => {
        let o = false, i2, l;
        e.right.type === "JsdocTypeSpecialNamePath" && e.right.specialType === "event" ? (o = true, i2 = e.right.value, l = V(e.right.meta.quote)) : (i2 = e.right.value, l = V(e.right.meta.quote));
        let f = {
          type: lr(e.pathType),
          owner: t(e.left),
          name: i2,
    ...
    function ke(e, t, o, i2, l) {
      i2 == null ? void 0 : i2(e, t, o);
      let f = tt[e.type];
      for (let d of f) {
        let h = e[d];
        if (h !== void 0)
...
var B = r((n) => {
  ...
  switch (typeof a < "u" && (p.raw = a), n.name) {
    ...
    case "signature":
      return { ...p, ...Nr(n) };
    case "union":
      return ((_a2 = n.elements) == null ? void 0 : _a2.every(Sr)) ? { ...p, name: "enum", value: (_b = n.elements) == null ? void 0 : _b.map(Er) } : { ...p, name: s, value: (_c = n.elements) == null ? void 0 : _c.map(B) };
    case "intersection":
...
var M = r((n) => {
  ...
  switch (typeof a < "u" && (p.raw = a), n.name) {
    ...
    case "union":
      let c;
      return ((_a2 = n.elements) == null ? void 0 : _a2.every((u) => u.name === "literal")) ? c = {
        ...p,
        name: "enum",
...
function ye(n, s) {
  ...
  if (s == null ? void 0 : s.includesJsDoc) {
    ...
    let c = {
      ...p,
      params: (_a2 = p == null ? void 0 : p.params) == null ? void 0 : _a2.map(
        (u) => ({
...
var yn = r((n) => {
  ...
  return n.map((p) => {
    var _a2;
    let c = p;
    return ((_a2 = p.type) == null ? void 0 : _a2.elements) && (c = {
      ...p,
      type: {
        ...p.type,
...
var require_quick_sort = __commonJS({ "../../node_modules/escodegen/node_modules/source-map/lib/quick-sort.js"(exports) {
  ...
  function doQuickSort(ary, comparator, p, r2) {
    if (p < r2) {
      ...
      for (var pivot = ary[r2], j = p; j < r2; j++) comparator(ary[j], pivot) <= 0 && (i2 += 1, swap(ary, i2, j));
      swap(ary, i2 + 1, j);
      var q = i2 + 1;
...
`, space: " ", json: false, renumber: false, hexadecimal: false, quotes: "single", escapeless: false, compact: false, parentheses: true, semicolons: true, safeConcatenation: false, preserveBlankLines: false }, moz: { comprehensionExpressionStartsWithAssignment: false, starlessGenerator: false }, sourceMap: null, sourceMapRoot: null, sourceMapWithCode: false, directive: false, raw: true, verbatim: null, sourceCode: null };
    ...
    function withIndent(fn2) {
      var previousBase;
      previousBase = base2, base2 += indent, fn2(base2), base2 = previousBase;
    }
    ...
    function adjustMultilineComment(value, specialBase) {
      var array, i2, len, line, j, spaces, previousBase, sn2;
      ...
      for (typeof specialBase < "u" ? (previousBase = base2, array[1][spaces] === "*" && (specialBase += " "), base2 = specialBase) : (spaces & 1 && --spaces, previousBase = base2), i2 = 1, len = array.length; i2 < len; ++i2) sn2 = toSourceNodeWhenNeeded(addIndent(array[i2].slice(spaces))), array[i2] = sourceMap ? sn2.join("") : sn2;
...
base.NewExpression = base.CallExpression = function(node, st2, c) {
  if (c(node.callee, st2, "Expression"), node.arguments) for (var i2 = 0, list = node.arguments; i2 < list.length; i2 += 1) {
    var arg = list[i2];
...
function calculateNodeDepth(node) {
  let depths = [];
  return ancestor(node, { ObjectExpression(_2, ancestors) {
    depths.push(filterAncestors(ancestors).length);
  }, ArrayExpression(_2, ancestors) {
    depths.push(filterAncestors(ancestors).length);
